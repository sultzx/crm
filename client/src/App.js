...
import {  Signin, Signup, Profile, Employees, Chat, OrderPage, Departments, AddEmployee, Projects, AddProject, Calendar, Main, CreateReport, Reports} from './pages/index.js'
...
function App() {
  ...
  <Routes>
    ...
    <Route path="/reports/create" element={<><Header/><CreateReport/></>  } />
