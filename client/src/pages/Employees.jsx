...
import { BookFill, Calendar, Calendar2, Calendar2Date, CardChecklist, Envelope, GenderAmbiguous, GenderFemale, GenderMale, Grid, Person, PersonVcard, Phone, Stopwatch } from 'react-bootstrap-icons'
                ...
                <br />
                {
                    employees?.map((emp, i) => (
                        <Col md={12} style={{
                            ...
                            <Row>
                                <Col md={2}>
                                    <img src={emp?.avatar ? `https://crm-mm45.onrender.com/${emp?.avatar}` :
                                ...
                                <Col md={6} className="d-flex row align-items-center justify-content-start text-start">
                                    ...
                                    <p><CardChecklist size={'28px'} color="#5667FF" />&nbsp; {emp?.job}</p>
                                    <p><Person size={'28px'} color="#5667FF" />&nbsp; {emp?.bio}</p>
                                </Col>

                                {data?.role == 'manager' && emp?.status == 'inactive' &&
                                    <Col md={4} className="d-flex align-items-end justify-content-end text-end">
