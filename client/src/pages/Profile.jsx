                ...
                <Col md={9} style={{
                    ...
                    <Form onSubmit={handleSubmit(onSubmit)} method="post">
                        ...
                        <Row>
                            ...
                            <Col md={6}>
                                <Form.Group className="mb-3">
                                    <Form.Label style={{ color: 'black', textShadow: 'none' }}>Телефон</Form.Label>
                                    <input type="text" value={phone}
                                        onChange={event => setPhone(event.target.value)} placeholder={data?.phone} className="form-control phone" style={{
                                            backgroundColor: 'white'
                                        }} />
                                    {/* <PhoneInput
                                        style={
                            ...
                            <Col md={12}>
                                <Form.Group className="mb-3">
                                    <Form.Label style={{ color: 'black', textShadow: 'none' }}>Қызмет атауы</Form.Label>
                                    <input type="text" value={job} className="form-control" placeholder={data?.job ? data?.job : "Қызметкер атқаратын қызметін енгізіңіз"} onChange={event => setJob(event.target.value)}
                                        style={{
                                            backgroundColor: 'white',
                                            height: 'auto'
                                        }} />
                            ...
                            <Col md={12}>
                                <Form.Group className="mb-3">
                                    ...
                                    <textarea type="text" placeholder={data?.bio} value={bio} className="form-control" rows={6} onChange={event => setBio(event.target.value)}
                                        style={{
                                            backgroundColor: 'white',
                                            height: 'auto'
                                        }} />
